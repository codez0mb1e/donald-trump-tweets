...
using WikipediaDetox.ML.Model.DataModels;

namespace WikipediaDetox.ML.Host
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\repos\donald-trump-tweets\data\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../DonaldTrumpTweetsML.Model/MLModel.zip";
